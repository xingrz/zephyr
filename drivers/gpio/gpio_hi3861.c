...
#define GPIO_REG DT_INST_REG_ADDR(0)

#define GPIO_SWPORT_DR	   (GPIO_REG + 0x00)
#define GPIO_SWPORT_DDR	   (GPIO_REG + 0x04)
#define GPIO_INTEN	   (GPIO_REG + 0x30)
#define GPIO_INTMASK	   (GPIO_REG + 0x34)
#define GPIO_INTTYPE_LEVEL (GPIO_REG + 0x38)
#define GPIO_INT_POLARITY  (GPIO_REG + 0x3c)
#define GPIO_INTSTATUS	   (GPIO_REG + 0x40)
#define GPIO_RAWINTSTATUS  (GPIO_REG + 0x44)
#define GPIO_PORT_EOI	   (GPIO_REG + 0x4c)
#define GPIO_EXT_PORT	   (GPIO_REG + 0x50)
