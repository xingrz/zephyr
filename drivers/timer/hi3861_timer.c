...
#define TIMER_REG DT_INST_REG_ADDR(0)

#define TIMER_0 (TIMER_REG + 0x00)
#define TIMER_1 (TIMER_REG + 0x14)
#define TIMER_2 (TIMER_REG + 0x28)
#define TIMER_3 (TIMER_REG + 0x3C)
...
{
	return last_ticks * CYCLES_PER_TICK;
}
